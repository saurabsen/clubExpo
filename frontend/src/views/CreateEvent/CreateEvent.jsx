    ...
    <Card>
      ...
      >
        ...
        <FormControl variant="standard">
          ...
          <Input id="formMaxAttendees" onChange={onChangeHandler} name='availableSpots' type='number' />
        </FormControl>
        ...
        <FormControl variant="standard">
          ...
          <Input id="formEventImageURL" onChange={onChangeHandler} name='featureImage' value='https://picsum.photos/id/1006/600/600'/>
        </FormControl>
        <Box sx={{display: 'flex', gap: '50px'}}>
          <Link to='/home'><Button variant='outlined'>Exit</Button></Link>
